...
static const char *const autostart[] = {
    "bash", "-c",
    "swaybg -i /home/guillermo/Pictures/wallpapers/pixel.png -m fill & \
         sleep 1;\
         EXTERNAL_OUTPUT=$(wlr-randr | awk '/^[^ ]/ && !/eDP/ { print $1; exit }'); \
         if [ -n \"$EXTERNAL_OUTPUT\" ]; then \
             wlr-randr --output \"$EXTERNAL_OUTPUT\" --on --preferred; \
...
static const Key keys[] = {
	...
	{ MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_L,          spawn,          SHCMD("swaylock --image ~/Pictures/screenLock.png") },
	// { MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_L,          spawn,          SHCMD("swaylock --image ~/Pictures/wallpaperpoliedro.png") },
	// { MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_L,          spawn,          SHCMD("swaylock --image ~/_.png") },
